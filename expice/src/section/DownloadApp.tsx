...
const DownloadApp = (props: Props) => {
  return (
    <div className="my-20  min-h-[100vh] w-full bg-bg-secondary px-4">
      <div className="mx-auto min-h-[100vh] max-w-7xl grid-cols-2 items-center justify-center md:grid">
        <div className="flex flex-col items-center ">
          ...
          <div className="flex self-start">
            <div className="ml-12 flex cursor-pointer items-center gap-2 rounded-lg bg-black p-3  text-primary-para">
              <div>
            ...
            <div className="ml-5 flex cursor-pointer items-center gap-2 rounded-lg bg-black p-3  text-primary-para">
              <div>
        ...
        <div className="">
          <img src={mobile} alt="mobile" className="-ml-28 md:ml-0" />
        </div>
      </div>
    </div>
  );
